!(function (e, t) {
  ...
  var ie = (function (e) {
    ...
    for (y in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })
      b.pseudos[y] = a(y);
    for (y in { submit: !0, reset: !0 }) b.pseudos[y] = u(y);
    return (
    ...
    closest: function (e, t) {
      for (
        var n,
          ...
          i = this.length,
          o = [],
          s = ae.test(e) || "string" != typeof e ? Z(e, t || this.context) : 0;
        i > r;
        r++
      )
  ...
  Z.extend({
    ...
    (Z.cssHooks.marginRight = N(K.reliableMarginRight, function (e, t) {
      return t
        ? Xe(e, { display: "inline-block" }, E, [e, "marginRight"])
        : void 0;
    })),
    ...
    toggleClass: function (e, t) {
      ...
      return "boolean" == typeof t && "string" === n
        ...
        : this.each(function () {
            var t, r, i, o;
            if ("string" === n)
              for (r = 0, i = Z(this), o = e.match(he) || []; (t = o[r++]); )
    ...
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !f.noBubble && !Z.isWindow(r)) {
          for (
            u = f.delegateType || d, ut.test(u + d) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            p.push(s), (a = s);
  ...
  (Z.fn.load = function (e, t, n) {
    ...
    return (
      ...
      s.length > 0 &&
        Z.ajax({ url: e, type: i || "GET", dataType: "html", data: t })
          .done(function (e) {
            (o = arguments),
    ...
    var s = "sf-breadcrumb",
      ...
      u = function (e) {
        ...
        (s = "pan-y" === (s = s || t) ? "auto" : "pan-y"),
          e.css({ "ms-touch-action": s, "touch-action": s });
      },
      f = function (e) {
        return e.closest("." + o);
      },
  ...
  o.fn.UItoTop = function (n) {
    ...
    o("body").append(
      ...
      o(t)
        ...
        .hover(
          function () {
            o(i, this).stop().animate({ opacity: 1 }, 600, "linear");
          },
          function () {
            o(i, this).stop().animate({ opacity: 0 }, 700, "linear");
          }
        ),
      o(window).scroll(function () {
        var n = o(window).scrollTop();
        void 0 === document.body.style.maxHeight &&
          o(t).css({ position: "absolute", top: n + o(window).height() - 50 }),
...
!(function (l, e) {
  ...
  "use strict";
  function e(e) {
    if (o.webkit && !e) return { height: 0, width: 0 };
    if (!o.data.outer) {
      var s = {
        border: "none",
      ...
      (s.isVisible = d - h > 1),
        ...
        "y" === e &&
          (r.is("textarea") || d < h
            ...
            : t.css({ "max-height": h + o.scroll.height + "px" })),
      ...
      function o() {
        t(".pp_loaderIcon").hide(),
          ...
          $pp_pic_holder
            .find(".pp_content")
            .animate(
              { height: c.contentHeight, width: c.contentWidth },
