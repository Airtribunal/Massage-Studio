!(function (e, t) {
  ...
  function o() {
    X.removeEventListener("DOMContentLoaded", o),
  ...
  function f(e, t, n, r, i) {
    for (
      ...
      for (
        ...
        u = De[a] || De._default,
        s.innerHTML = u[1] + Z.htmlPrefilter(o) + u[2],
        p = u[0]; p--;
    ...
    for (d.textContent = "", g = 0;
      (o = h[g++]);)
      if (r && Z.inArray(o, r) > -1) i && i.push(o);
      else if (
      ((f = Z.contains(o.ownerDocument, o)),
        (s = l(d.appendChild(o), "script")),
        f && c(s),
        n)
    )
      for (p = 0;
        (o = s[p++]);) je.test(o.type || "") && n.push(o);
    return d;
  }
  ...
  function x(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        ye.hasData(e) &&
        ((o = ye.access(e)), (s = ye.set(t, o)), (l = o.events))
      ) {
      ...
      xe.hasData(e) &&
        ((a = xe.access(e)), (u = Z.extend({}, a)), xe.set(t, u));
    }
  }
  ...
  function w(e, t, n, r) {
    ...
    var i,
      ...
      g = t[0],
      v = Z.isFunction(g);
    if (v || (d > 1 && "string" == typeof g && !K.checkClone && Pe.test(g)))
    ...
    if (
      ...
      for (a = (s = Z.map(l(i, "script"), m)).length; d > p; p++)
        (u = i),
        p !== h &&
        ((u = Z.clone(u, !0, !0)), a && Z.merge(s, l(u, "script"))),
        n.call(e[p], u, p);
      if (a)
        for (c = s[s.length - 1].ownerDocument, Z.map(s, y), p = 0; a > p; p++)
          (u = s[p]),
          je.test(u.type || "") &&
          !ye.access(u, "globalEval") &&
          Z.contains(c, u) &&
          (u.src ?
            Z._evalUrl && Z._evalUrl(u.src) :
            Z.globalEval(u.textContent.replace(Me, "")));
    }
    return e;
  }
  ...
  function T(e, t, n) {
    for (var r, i = t ? Z.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || Z.cleanData(l(r)),
      r.parentNode &&
      (n && Z.contains(r.ownerDocument, r) && c(l(r, "script")),
  ...
  function D(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (s += Z.css(e, n + ke[o], !0, i)),
      r ?
      ("content" === n && (s -= Z.css(e, "padding" + ke[o], !0, i)),
        "margin" !== n &&
        (s -= Z.css(e, "border" + ke[o] + "Width", !0, i))) :
      ((s += Z.css(e, "padding" + ke[o], !0, i)),
        "padding" !== n &&
        (s += Z.css(e, "border" + ke[o] + "Width", !0, i)));
    return s;
  }
  ...
  function A(e, t, n) {
    ...
    if (0 >= i || null == i) {
      if (((0 > (i = E(e, t, o)) || null == i) && (i = e.style[t]), Be.test(i)))
        return i;
  ...
  function q(e, t) {
    for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)
      (r = e[s]).style &&
      ((o[s] = ye.get(r, "olddisplay")),
        (n = r.style.display),
        t ?
        (o[s] || "none" !== n || (r.style.display = ""),
          "" === r.style.display &&
          Ee(r) &&
          (o[s] = ye.access(r, "olddisplay", k(r.nodeName)))) :
        ((i = Ee(r)),
          ("none" === n && i) ||
          ye.set(r, "olddisplay", i ? n : Z.css(r, "display"))));
    for (s = 0; a > s; s++)
      (r = e[s]).style &&
  ...
  function O(e, t) {
    ...
    for (t = t ? 1 : 0; 4 > r; r += 2 - t)
      (n = ke[r]), (i["margin" + n] = i["padding" + n] = e);
  ...
  function P(e, t, n) {
    ...
    for (
      ...
      if ((r = P.prefilters[o].call(l, e, c, l.opts)))
        return (
          Z.isFunction(r.stop) &&
          (Z._queueHooks(l.elem, l.opts.queue).stop = Z.proxy(r.stop, r)),
          r
        );
    return (
      Z.map(c, F, l),
      ...
      return (
        ...
        r(function (r, a, u, l) {
          var c,
            ...
            x = i ? (s || (r ? e : v || o) ? [] : a) : y;
          if ((i && i(y, x, u, l), o))
            for (c = g(x, h), o(c, [], u, l), f = c.length; f--;)
              (p = c[f]) && (x[h[f]] = !(y[h[f]] = p));
          if (r) {
            if (s || e) {
              if (s) {
      ...
      (E = t.select =
        function (e, t, n, r) {
          ...
          if (((n = n || []), 1 === f.length)) {
            ...
            for (
              i = fe.needsContext.test(e) ? 0 : o.length; i-- && ((s = o[i]), !b.relative[(a = s.type)]);
  ...
  (Z.uniqueSort = Z.unique = ie.uniqueSort),
  (Z.text = ie.getText),
  (Z.isXMLDoc = ie.isXML),
  ...
  Z.fn.extend({
    ...
    is: function (e) {
      return !!r(
        this,
        "string" == typeof e && ae.test(e) ? Z(e) : e || [],
        !1
      ).length;
    },
  });
      ...
      if (r[1]) {
        if (
          ((t = t instanceof Z ? t[0] : t),
            Z.merge(
              this,
              Z.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : X, !0)
            ),
            ue.test(r[1]) && Z.isPlainObject(t))
        )
          for (r in t)
            Z.isFunction(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
        return this;
      }
      return (
      ...
      closest: function (e, t) {
        for (
          var n,
            ...
            i = this.length,
            o = [],
            s = ae.test(e) || "string" != typeof e ? Z(e, t || this.context) : 0; i > r; r++
        )
      ...
      function (e, t) {
        Z.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
            (de[e] || Z.uniqueSort(i), pe.test(e) && i.reverse()),
            this.pushStack(i)
          );
        };
      }
              ...
              (function t(n) {
                Z.each(n, function (n, r) {
                  Z.isFunction(r) ?
                    ...
                    r && r.length && "string" !== Z.type(r) && t(r);
                });
              })(arguments),
              n && !t && u()),
            this
    ...
    (Z.ready.promise = function (t) {
      return (
        ...
        ((ge = Z.Deferred()),
          ...
          e.setTimeout(Z.ready) :
          (X.addEventListener("DOMContentLoaded", o),
        ...
        if (void 0 === t) this.register(e);
          ...
          Z.isArray(t) ?
            ...
            ((i = Z.camelCase(t)),
              t in o ?
              (r = [t, i]) :
              ((r = i), (r = r in o ? [r] : r.match(he) || []))),
            (n = r.length);
          for (; n--;) delete o[r[n]];
        }
        (void 0 === t || Z.isEmptyObject(o)) &&
    ...
    Z.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((i = xe.get(o)), 1 === o.nodeType && !ye.get(o, "hasDataAttrs"))
          ) {
            for (n = s.length; n--;)
              s[n] &&
              0 === (r = s[n].name).indexOf("data-") &&
              ((r = Z.camelCase(r.slice(5))), a(o, r, i[r]));
            ...
            function (t) {
              ...
              if (o && void 0 === t) {
                if (
                  ...
                  (n =
                    xe.get(o, e) ||
                    xe.get(o, e.replace(we, "-$&").toLowerCase()))
                )
                  return n;
                if (((r = Z.camelCase(e)), void 0 !== (n = xe.get(o, r))))
                  return n;
  ...
  (Z.event = {
    ...
    fix: function (e) {
      ...
      for (
        s ||
        (this.fixHooks[i] = s =
          Le.test(i) ? this.mouseHooks : qe.test(i) ? this.keyHooks : {}),
  ...
  Z.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (t)
          if (n)
            for (o = o || l(e), s = s || l(a), r = 0, i = o.length; i > r; r++)
              x(o[r], s[r]);
          else x(e, a);
    ...
    Z.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (Z.cleanData(l(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return ve(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !Fe.test(e) &&
              !De[(Se.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = Z.htmlPrefilter(e);
              try {
                for (; r > n; n++)
                  1 === (t = this[n] || {}).nodeType &&
                  (Z.cleanData(l(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return w(
          ...
          function (t) {
            ...
            Z.inArray(this, e) < 0 &&
              (Z.cleanData(l(this)), n && n.replaceChild(t, this));
          },
          e
        );
      },
      ...
      style: function (e, t, n, r) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var i,
            ...
            l = e.style;
          return (
            (t = Z.cssProps[a] || (Z.cssProps[a] = S(a) || a)),
      ...
      Z.cssHooks[t] = {
        ...
        set: function (e, n, r) {
          var i,
            o = r && _e(e),
            s =
            r && D(e, t, r, "border-box" === Z.css(e, "boxSizing", !1, o), o);
          return (
            s &&
            (i = Ce.exec(n)) &&
            "px" !== (i[3] || "px") &&
            ((e.style[t] = n), (n = Z.css(e, t))),
            j(0, n, s)
          );
        },
      };
      ...
      function (e, t, n) {
        ...
        n.queue ||
          ...
          ((n.overflow = [p.overflow, p.overflowX, p.overflowY]),
            "inline" ===
            ("none" === (l = Z.css(e, "display")) ?
              ye.get(e, "olddisplay") || k(e.nodeName) :
              l) &&
            "none" === Z.css(e, "float") &&
        ...
        if (Z.isEmptyObject(f))
          "inline" === ("none" === l ? k(e.nodeName) : l) && (p.display = l);
        else {
          h
            ?
            "hidden" in h && (d = h.hidden) :
            (h = ye.access(e, "fxshow", {})),
            o && (h.hidden = !d),
            d ?
            Z(e).show() :
            c.done(function () {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return void 0 === e.getAttribute ?
            ...
            ((1 === o && Z.isXMLDoc(e)) ||
              ((t = t.toLowerCase()),
                (i =
                  Z.attrHooks[t] || (Z.expr.match.bool.test(t) ? tt : void 0))),
              void 0 !== n ?
              null === n ?
    ...
    toggleClass: function (e, t) {
      ...
      return "boolean" == typeof t && "string" === n ?
        ...
        this.each(function () {
          var t, r, i, o;
          if ("string" === n)
            for (r = 0, i = Z(this), o = e.match(he) || [];
              (t = o[r++]);)
              i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
          else
            (void 0 !== e && "boolean" !== n) ||
            ((t = R(this)) && ye.set(this, "__className__", t),
              this.setAttribute &&
              this.setAttribute(
                "class",
                t || !1 === e ? "" : ye.get(this, "__className__") || ""
              ));
        });
    },
    hasClass: function (e) {
  ...
  Z.fn.extend({
        ...
        return arguments.length ?
          ((r = Z.isFunction(e)),
            this.each(function (n) {
              var i;
              1 === this.nodeType &&
                (null == (i = r ? e.call(this, n, Z(this).val()) : e) ?
                  (i = "") :
                  "number" == typeof i ?
                  (i += "") :
                  Z.isArray(i) &&
    ...
    Z.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, r, i = e.options, o = Z.makeArray(t), s = i.length; s--;

            )
              (r = i[s]),
              (r.selected = Z.inArray(Z.valHooks.option.get(r), o) > -1) &&
              (n = !0);
    ...
    Z.each(["radio", "checkbox"], function () {
      (Z.valHooks[this] = {
        set: function (e, t) {
          return Z.isArray(t) ?
            (e.checked = Z.inArray(Z(e).val(), t) > -1) :
            void 0;
        },
      }),
      K.checkOn ||
      ...
      trigger: function (t, n, r, i) {
        ...
        if (
          ...
          if (!i && !f.noBubble && !Z.isWindow(r)) {
            for (
              u = f.delegateType || d, ut.test(u + d) || (s = s.parentNode); s; s = s.parentNode
            )
              p.push(s), (a = s);
            a === (r.ownerDocument || X) &&
          ...
          for (o = 0;
            ...
            (c = (ye.get(s, "events") || {})[t.type] && ye.get(s, "handle")) &&
            c.apply(s, n),
            (c = l && s[l]) &&
            c.apply &&
            me(s) &&
      ...
      Z.event.special[t] = {
        ...
        teardown: function () {
          ...
          i
            ?
            ye.access(r, t, i) :
            (r.removeEventListener(e, n, !0), ye.remove(r, t));
        },
      };
    });
  var lt = e.location,
  ...
  Z.extend({
      ...
      ajax: function (t, n) {
            ...
            ((b = 2),
              ...
              (p.ifModified &&
                ((w = T.getResponseHeader("Last-Modified")) &&
                  (Z.lastModified[o] = w),
                  (w = T.getResponseHeader("etag")) && (Z.etag[o] = w)),
                204 === t || "HEAD" === p.type ?
                (C = "nocontent") :
                304 === t ?
                (C = "notmodified") :
          ...
          T = {
            ...
            getResponseHeader: function (e) {
              ...
              if (2 === b) {
                if (!a)
                  for (a = {};
                    (t = ht.exec(s));) a[t[1].toLowerCase()] = t[2];
                t = a[e.toLowerCase()];
              }
        ...
        0 == Z.active++ &&
          ...
          p.hasContent ||
          (p.data &&
            ((o = p.url += (ft.test(o) ? "&" : "?") + p.data), delete p.data),
            !1 === p.cache &&
            (p.url = dt.test(o) ?
              o.replace(dt, "$1_=" + ct++) :
              o + (ft.test(o) ? "&" : "?") + "_=" + ct++)),
          p.ifModified &&
          (Z.lastModified[o] &&
            T.setRequestHeader("If-Modified-Since", Z.lastModified[o]),
            Z.etag[o] && T.setRequestHeader("If-None-Match", Z.etag[o])),
    ...
    Z.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      return a || "jsonp" === t.dataTypes[0] ?
        ((i = t.jsonpCallback =
          ...
          r.always(function () {
            void 0 === o ? Z(e).removeProp(i) : (e[i] = o),
  ...
  Z.each(
    ...
    Z.fn.extend({
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            var e = this.offsetParent; e && "static" === Z.css(e, "position");
    ...
    Z.each(["top", "left"], function (e, t) {
      Z.cssHooks[t] = N(K.pixelPosition, function (e, n) {
        return n ?
          ((n = E(e, t)), Be.test(n) ? Z(e).position()[t] + "px" : n) :
          void 0;
      });
    }),
    Z.each({
      ...
      if (
        ...
        if ((this.$element.trigger(s), !s.isDefaultPrevented())) {
          ...
          this.$element
            ...
            .emulateTransitionEnd(o.TRANSITION_DURATION)[a](this.$element[0][l]);
        }
      }
    }
  }),
      ...
      a = function (t, n) {
        if (
          ((n.hoverIntent_t = clearTimeout(n.hoverIntent_t)),
            Math.abs(u - v) + Math.abs(s - i) < r.sensitivity)
        )
          return (
    ...
    var s = "sf-breadcrumb",
      ...
      m = function () {
        ...
        r
          ...
          e.proxy(v, t, s)() :
          (clearTimeout(s.sfTimer),
            (s.sfTimer = setTimeout(e.proxy(v, t, s), s.delay)));
      },
      y = function (t) {
        var s = e(this),
          o = c(s),
      ...
      destroy: function () {
        return this.each(function () {
          var t,
            ...
            n = o.data("sfOptions");
          if (!n) return !1;
          (t = o.find(n.popUpSelector).parent("li")),
          clearTimeout(n.sfTimer),
            ...
            n.$path.removeClass(n.hoverClass + " " + s).addClass(n.pathClass),
            o.find("." + n.hoverClass).removeClass(n.hoverClass),
            n.onDestroy.call(o),
        ...
        ((o.overlay = (function () {
          ...
          l(window).resize(function () {
            ...
            if (o.scroll && (o.scroll.height || o.scroll.width)) {
              var s = e();
              (s.height === o.scroll.height && s.width === o.scroll.width) ||
              ((o.scroll = s), (l = !0));
            }
            n(l);
          })),
  ...
  t.prototype = {
    ...
    init: function (e) {
      ...
      if (d)
        ...
        (h[a.isRtl ? "margin-left" : "margin-right"] = -1 * o.scroll.width + "px"),
        i.css(h);
      else {
        if (
          ((this.wrapper = d =
            ...
            t.on("scroll" + n, function (e) {
              ...
              l.isFunction(a.onScroll) &&
                ...
                c.x.isVisible && c.x.scroll.bar.css("left", s * c.x.kx + "px"),
      ...
      l.each(c, function (e, i) {
          var d = null,
            ...
            v = 0;
          i.scroll ||
            ((i.scroll = r._getScroll(a["scroll" + e]).addClass("scroll-" + e)),
              ...
              .on("mousedown" + n, function (s) {
                ...
                h = 1;
                var n = s["x" === e ? "pageX" : "pageY"],
                  c = i.size - i.visible - i.offset,
                  m = i.scroll.bar.offset()["x" === e ? "left" : "top"],
                  g = i.scroll.bar["x" === e ? "outerWidth" : "outerHeight"](),
                  b = 0,
                  x = 0;
                ...
                } else(h = n > m + g ? 1 : n < m ? -1 : 0), "x" === e && a.isRtl && (o.msie || o.msedge) && (h *= -1), (p = Math.round(0.75 * i.visible) * h), (v = n - m - (a.stepScrolling ? (1 == h ? g : 0) : Math.round(g / 2))), (v = t[u]() + v / i.kx);
                return (
                  (r.scrollTo = r.scrollTo || {}),
                  (r.scrollTo[u] = a.stepScrolling ? t[u]() + p : v),
                  a.stepScrolling &&
                  ((d = function () {
                      (v = t[u]()),
                      clearInterval(x),
                  ...
                  setTimeout(function () {
                    r.scrollTo &&
                      (t.animate(r.scrollTo, a.duration), (r.scrollTo = null));
                  }, 1),
              ...
              i.scroll.bar.on("mousedown" + n, function (s) {
                ...
                return (
                  ...
                  l(document).on("mousemove" + n, function (l) {
                    ...
                    "x" === e && a.isRtl && (o.msie || o.msedge) && (s *= -1),
                      t[u](d + s);
                  }),
    ...
    return function (s) {
      ...
      for (r = 0; r < o.scrolls.length; r++)
        ...
        (a.init(),
          ...
          (window.console &&
            console.log({
                scrollHeight: t.prop("scrollHeight") + ":" + a.scrolly.size,
                scrollWidth: t.prop("scrollWidth") + ":" + a.scrollx.size,
...
!(function (t) {
  function e() {
    var t = location.href;
    return (
      (hashtag = -1 !== t.indexOf("#prettyPhoto") &&
  ...
  (t.fn.prettyPhoto = function (p) {
    function o() {
      t(".pp_loaderIcon").hide(),
        (projectedTop =
          scroll_pos.scrollTop + (b / 2 - c.containerHeight / 2)),
        ...
        $pp_pic_holder.animate({
            top: projectedTop,
            left: k / 2 - c.containerWidth / 2 < 0 ?
              0 :
              k / 2 - c.containerWidth / 2,
          ...
          function () {
            $pp_pic_holder
              ...
              isSet && "image" == l(pp_images[set_position]) ?
        ...
        "image" == l(pp_images[set_position]) ?
        ((itemWidth = 57),
          (navWidth =
          ...
          (itemsPerPage = Math.floor(
            (c.containerWidth - 100 - navWidth) / itemWidth
          )),
          (itemsPerPage =
    ...
    function s(t, e) {
      if (
        ((resized = !1),
          ...
          (imageWidth = t),
          (imageHeight = e),
          (f > k || u > b) && doresize && settings.allow_resize && !w)
      ) {
        for (resized = !0, fitting = !1; !fitting;)
          f > k ?
          ((imageWidth = k - 200), (imageHeight = (e / t) * imageWidth)) :
          u > b ?
          ((imageHeight = b - 200), (imageWidth = (t / e) * imageHeight)) :
          (fitting = !0),
          (u = imageHeight),
          (f = imageWidth);
        (f > k || u > b) && s(f, u), n(imageWidth, imageHeight);
      }
      return {
        width: Math.floor(imageWidth),
        height: Math.floor(imageHeight),
        containerHeight: Math.floor(u),
        containerWidth: Math.floor(f) + 2 * settings.horizontal_padding,
      ...
      if (doresize && "undefined" != typeof $pp_pic_holder) {
        if (
          ((scroll_pos = d()),
            ...
            (projectedTop = b / 2 + scroll_pos.scrollTop - contentHeight / 2),
            projectedTop < 0 && (projectedTop = 0),
            contentHeight > b)
        )
          return;
    ...
    return (
      ...
      .bind("resize.prettyphoto", function () {
        r(),
          ...
          $pp_overlay.height(t(document).height()).width(k);
      }),
            ...
            switch (
              ...
              case "youtube":
                ...
                "" == movie_id &&
                  ...
                  (movie += i("rel", pp_images[set_position]) ?
                    "?rel=" + i("rel", pp_images[set_position]) :
                    "?rel=1"),
                  settings.autoplay && (movie += "&autoplay=1"),
                  (toInject = settings.iframe_markup
                    .replace(/{width}/g, c.width)
                    .replace(/{height}/g, c.height)
              ...
              case "vimeo":
                ...
                break;
              case "quicktime":
                ((c = s(movie_width, movie_height)).height += 15),
                (c.contentHeight += 15),
              ...
              case "inline":
                (myClone = t(pp_images[set_position])
                  ...
                  .show()),
                (doresize = !1),
                (c = s(t(myClone).width(), t(myClone).height())),
                (doresize = !0),
                t(myClone).remove(),
                  (toInject = settings.inline_markup.replace(
                    /{content}/g,
  ...
  t.JQPlugin.createPlugin({
    ...
    _calculatePeriods: function (t, e, i, s) {
      ...
      if (
        ...
        for (
          var m = [1, 12, 4.3482, 7, 24, 60, 60], g = 6, f = 1, w = 6; w >= 0; w--
        )
          e[w] &&
          (o[g] >= f && ((o[g] = 0), (h = 1)),
            h > 0 && (o[w]++, (h = 0), (g = w), (f = 1))),
        ...
        (t.bridget = function (o, n) {
          ...
          (function (o, n) {
            t.fn[o] = function (r) {
              if ("string" == typeof r) {
                for (
                  var s = i.call(arguments, 1), a = 0, u = this.length; u > a; a++
                ) {
                  var p = this[a],
                    h = t.data(p, o);
                  if (h)
                    if (t.isFunction(h[r]) && "_" !== r.charAt(0)) {
                      ...
                      e("no such method '" + r + "' for " + o + " instance");
                  else
                    e(
              ...
              return this.each(function () {
                ...
                e
                  ?
                  (e.option(r), e._init()) :
                  ((e = new n(this, r)), t.data(this, o, e));
              });
            };
          })(o, n);
        }),
...
function () {
    ...
    function i(i) {
      ...
      return function (p) {
        if (
          ...
          var f = {};
          (f.width = p.offsetWidth), (f.height = p.offsetHeight);
          for (
            var d = (f.isBorderBox = !(!s || !h[s] || "border-box" !== h[s])),
              l = 0,
              c = n.length; c > l; l++
          ) {
            var y = n[l],
          ...
          var v = f.paddingLeft + f.paddingRight,
            _ = f.paddingTop + f.paddingBottom,
            I = f.marginLeft + f.marginRight,
            z = f.marginTop + f.marginBottom,
            L = f.borderLeftWidth + f.borderRightWidth,
            x = f.borderTopWidth + f.borderBottomWidth,
            E = d && a,
            b = e(h.width);
          !1 !== b && (f.width = b + (E ? 0 : v + L));
          var S = e(h.height);
          return (
            !1 !== S && (f.height = S + (E ? 0 : _ + x)),
            (f.innerWidth = f.width - (v + L)),
            (f.innerHeight = f.height - (_ + x)),
            (f.outerWidth = f.width + I),
            (f.outerHeight = f.height + z),
            f
          );
        }
      };
  ...
  (function (t) {
    ...
    var o,
      n = (function () {
        ...
        for (
          var e = ["webkit", "moz", "ms", "o"], i = 0, o = e.length; o > i; i++
        ) {
    ...
    if (n) {
      ...
      o = function (t, e) {
        i(t);
        for (
          var o = t.parentNode.querySelectorAll(e), n = 0, r = o.length; r > n; n++
        )
          if (o[n] === t) return !0;
        return !1;
      };
      ...
      for (var n = [], r = 0, s = (t = o.makeArray(t)).length; s > r; r++) {
        ...
        if (o.isElement(a))
          if (e) {
            i(a, e) && n.push(a);
            for (
              var u = a.querySelectorAll(e), p = 0, h = u.length; h > p; p++
            )
              n.push(u[p]);
          } else n.push(a);
      }
  ...
  (function (t, e) {
    ...
    (r.prototype.transition =
      r.prototype[u ? "_transition" : "_nonTransition"]),
...
(function (t, e, i, s) {
  ...
  ((t.support.transition = new String(o("transition"))),
    (t.support.transition.end = h.end[t.support.transition])),
  d() &&
    ((t.support.animation = new String(o("animation"))),
      (t.support.animation.end = l.end[t.support.animation])),
    c() &&
    ((t.support.transform = new String(o("transform"))),
      (t.support.transform3d = p()));
})(window.Zepto || window.jQuery, window, document);
!(function (e) {
  var t = !0;
    ...
    e.widget("ui.slider", e.ui.mouse, {
      ...
      values: function (t, i) {
        ...
        if (!e.isArray(arguments[0]))
          return this.options.values && this.options.values.length ?
            ...
            this.value();
        for (
          s = this.options.values, n = arguments[0], a = 0; s.length > a; a += 1
        )
      ...
      _setOption: function (t, i) {
        ...
        switch (
          ...
          case "values":
            for (
              this._animateOff = !0, this._refreshValue(), s = 0; n > s; s += 1
            )
              this._change(null, s);
            this._animateOff = !1;
            break;
  ...
  t.fn.tweet = function (e) {
    ...
    function s(e) {
      ...
      return (
        ...
        (a.avatar_size = u.avatar_size),
        (a.avatar_url = i(e, "https:" === document.location.protocol)),
        (a.retweet = void 0 !== e.retweeted_status),
        (a.tweet_time = (function (t) {
          return Date.parse(
        ...
        (a.join_text =
          ...
          (function (t) {
            return t.match(/^(@([A-Za-z0-9-_]+)) .*/i) ?
              u.auto_join_text_reply :
              t.match(o) ?
              u.auto_join_text_url :
              t.match(/^((\w+ed)|just) .*/im) ?
              u.auto_join_text_ed :
              t.match(/^(\w*ing) .*/i) ?
              u.auto_join_text_ing :
              u.auto_join_text_default;
          })(e.text) :
          u.join_text),
        (a.tweet_id = e.id_str),
        (a.twitter_base = "http://" + u.twitter_url + "/"),
        ...
        (a.tweet_relative_time = (function (t) {
        ...
        (a.tweet_text = t([
            (function (t, e) {
              return t.replace(o, function (t) {
                for (
                  var r = /^[a-z]+:/i.test(t) ? t : "http://" + t, a = t, i = 0; i < e.length;
                  ++i
                ) {
                  var s = e[i];
    ...
    return (
      ...
      t.fn.extend({
        ...
        linkHash: a(
          ...
          (u.username && 1 == u.username.length && !u.list ?
            "&from=" + u.username.join("%2BOR%2B") :
            "") +
      ...
      this.each(function (e, a) {
        ...
        u.username &&
          "string" == typeof u.username &&
          (u.username = [u.username]),
          t(a)
          .unbind("tweet:load")
          .bind("tweet:load", function () {
            u.loading_text && t(a).empty().append(_),
              t.ajax({
                dataType: "json",
                type: "post",
                async: !0,
                ...
                data: {
                  request: (function () {
                    ...
                    if (null === u.query && 1 === u.username.length)
                      return {
                        host: u.twitter_api_url,
  ...
  t.fn.addWidthClass = function (i) {
    for (
      var e = t.extend({
        ...
        n = "",
        r = e.breakpoints.length - 1; r >= 0; r--
    )
      n += " width-lt-" + e.breakpoints[r] + " width-gt-" + e.breakpoints[r];
    return this.each(function () {
      for (
        var t = jQuery(this), i = "", r = e.breakpoints.length - 1; r >= 0; r--
      )
